package com.example.beauty_cam.glcamera.camera;
...
import com.example.beauty_cam.glcamera.interfaces.ImageCallback;
...
public class CameraCore {
    ...
    public CameraCore(SurfaceView surfaceView,Context context) {
    ...
    private void setCameraDisplayOrientation(int cameraId) {
        ...
        Log.v(" openCamera===================>2", cameraId+"");
        WindowManager manager = (WindowManager) mContext.getSystemService(Context.WINDOW_SERVICE);
        int rotation = manager.getDefaultDisplay()
                .getRotation();
        Log.v(" openCamera===================>3", cameraId+"");
