package com.example.beauty_cam.glcamera.views;
...
import com.example.beauty_cam.glcamera.camera.CameraCore;
import com.example.beauty_cam.glcamera.filters.BaseFilter;
import com.example.beauty_cam.glcamera.filters.BeautyFilter;
import com.example.beauty_cam.glcamera.gpuimage.GPUImageNativeLibrary;
import com.example.beauty_cam.glcamera.grafika.my.HWRecorderWrapper;
import com.example.beauty_cam.glcamera.interfaces.FileCallback;
...
public class GLCameraView extends GLSurfaceView {
    ...
    public class GLRenderer implements Renderer,SurfaceTexture.OnFrameAvailableListener {
        ...
        public GLRenderer(GLSurfaceView surfaceView, FilterFactory.FilterType type) {
            ...
            mRecordingEnabled = false;
            mCameraHelper = new CameraCore(surfaceView,getContext());
